...
export const register = newUser => {
  return axios.post(`${REACT_APP_API_URL}/users/register`, {
...
export const login = user => {
  return axios.post(`${REACT_APP_API_URL}/users/login`, {
    email: user.email,
...
export const articles = newArticle => {
  return axios.post(`${REACT_APP_API_URL}/articles`, {
...
export const handleUpload = theFile => {
  ...
  return  axios.post(`${REACT_APP_API_URL}/upload`, theFile,  {withCredentials: true})
      .then(res => res.data)
      .catch(err => {
        console.log(err);
      });
...
export const logOut = () => (e) => {
  e.preventDefault();
  axios.post(`${REACT_APP_API_URL}/`,  {withCredentials: true});
